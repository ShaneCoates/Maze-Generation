...
//Define custom console instance
//
...
namespace ImGui
{
	...
	static IMGUI_API CustomConsole* m_customConsoleInstance;
	IMGUI_API CustomConsole* GetCustomConsoleInstance();
	IMGUI_API void			 ShowCustomConsole(bool* open = NULL);
	IMGUI_API void			 LogCustomConsole(char* _message);
	IMGUI_API char*          GetConsoleBuffer(); 
	IMGUI_API bool			 GetConsoleUpdated();
